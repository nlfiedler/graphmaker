 ...
 *
 * $Id: DefaultModelBeanInfo.java 2858 2007-02-26 09:05:03Z nfiedler $
 */
...
/**
 * BeanInfo for the DefaultModel class.
 *
 * @author Nathan Fiedler
 */
public class DefaultModelBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        beanDescriptor = new BeanDescriptor(DefaultModel.class);
...
//GEN-LAST:Superclass
    ...
    private static class Persistent extends DefaultPersistenceDelegate {
        ...
        protected void initialize(Class<?> type, Object oldInstance,
            ...
            DefaultModel model = (DefaultModel) oldInstance;

            out.writeStatement(new Statement(
                    oldInstance, "startTransaction", new Object[0]));
            ...
            out.writeStatement(new Statement(
                    oldInstance, "safeEndTransaction", new Object[0]));
        }
    }
}
