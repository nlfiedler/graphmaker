 ...
 *
 * $Id: HomePanel.java 2698 2006-12-26 08:01:41Z nfiedler $
 */
 ...
 */
public class HomePanel extends InstallerPanel implements
    ...
    public HomePanel() {
        ...
        for (int ii = 0; ii < CANDIDATE_PATH_LIST.length; ii++) {
            ...
            if (dir.exists()) {
                if (dir.isDirectory()) {
                    try {
                        File file = File.createTempFile("graphmaker", null, dir);
                        file.delete();
        ...
        home += File.separator + "graphmaker-" + version;
    ...
    private String validateDirectory(File dir) {
        ...
        if (dir.exists()) {
            ...
            try {
                File file = File.createTempFile("graphmaker", null, parent);
                file.delete();
            } catch (Exception e) {
                // I/O or security exceptions indicates we are
                // not permitted to write this directory.
    ...
    private void initComponents() {
        ...
        selectTextArea.setText(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("LBL_Home_Select_Text"));
        ...
        homeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("KEY_Home_Home").charAt(0));
        homeLabel.setLabelFor(homeTextField);
        homeLabel.setText(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("LBL_Home_Home_Label"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        browseButton.setMnemonic(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("KEY_Home_Browse").charAt(0));
        browseButton.setText(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("LBL_Home_Browse_Button"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
