 ...
 *
 * $Id: JdkPanel.java 2698 2006-12-26 08:01:41Z nfiedler $
 */
...
public class JdkPanel extends InstallerPanel implements
     ...
     * JDK since it is apparently not a sufficient version for GraphMaker.
     */
    ...
    private void initComponents() {
        ...
        selectTextArea.setText(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("LBL_Jdk_Select_Text"));
        ...
        homeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("KEY_Jdk_Home").charAt(0));
        homeLabel.setLabelFor(homeTextField);
        homeLabel.setText(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("LBL_Jdk_Home_Label"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        browseButton.setMnemonic(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("KEY_Jdk_Browse").charAt(0));
        browseButton.setText(java.util.ResourceBundle.getBundle("com/bluemarsh/graphmaker/installer/Form").getString("LBL_Jdk_Browse_Button"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
